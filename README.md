...
Sobre
Este repositório reúne meus writeups de máquinas (HTB / laboratórios) e anotações de estudo, publicados como um site estático com MkDocs e o tema Material for MkDocs.
...
mkdocs build
Deploy
O deploy é automático: cada push na branch main dispara o workflow do GitHub Actions (.github/workflows/deploy.yml), que executa mkdocs gh-deploy --force --strict e publica o site no GitHub Pages.
